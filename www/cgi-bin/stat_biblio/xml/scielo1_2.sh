...
. ./SetVar.txt
export ARQ=$TMP/$PPID.scielo1_2


rm -rf $ARQ.*

$UTL/mxget "@$HOM/scielo1_2cgi.pft" >$ARQ.gizmo.seq
...
$UTL/mx $ARQ.gizmo count=7 create=$ARQ.gizmo1 -all now
$UTL/mx "seq=$HOM/scielo1_2mod.sh{" "gizmo=$ARQ.gizmo1" -all now lw=0 pft=v1# >$ARQ.sh
