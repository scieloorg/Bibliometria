...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:include href="file:///home/statbiblio-sp/www/htdocs/stat_biblio/xsl/01_02.xsl" />	
        ...
        <tr>
        	...
        	<td width="80%">
                ...
                <blockquote>
                    <ul>
        		    <li>
                            <a href="/scielolog.php?script=sci_journalstat&amp;lng=en&amp;pid={$issn}"><xsl:value-of select="$texts/text[find='JOURNAL_ACCESS']/replace" /></a>
                        </li>
                        <li>
                            <a href="/scielolog.php?script=sci_statiss&amp;lng=en&amp;pid={$issn}"><xsl:value-of select="$texts/text[find='ISSUE_ACCESS']/replace" /></a>
                        </li>
                        <li>
                            <a href="/scielolog.php?script=sci_statart&amp;lng=en&amp;pid={$issn}"><xsl:value-of select="$texts/text[find='ARTICLE_ACCESS']/replace" /></a>
                        </li>
                    </ul>
                </blockquote>
                <blockquote>
                ...
                <blockquote>
                    <ul>
                        <li><a href="index.php?state=16&amp;lng={$lang}&amp;issn={$issn}"><xsl:value-of select="$texts/text[find='CO_AUTHOR']/replace" /></a></li>
                    </ul>
                </blockquote>
                <blockquote>
                    <p>
