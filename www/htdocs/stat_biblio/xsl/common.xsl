...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		...
		**** File: file:///home/scielo/www/htdocs/stat_biblio/xsl/common.xsl
		...
		<script language="javascript">
			<xsl:attribute name="src">
				<xsl:value-of select="$path_javascript"/>
			</xsl:attribute>
		</script>
	</xsl:template>
	...
	<xsl:template name="footer">
		...
		**** File: file:///home/scielo/www/htdocs/stat_biblio/xsl/common.xsl
		...
		<hr/>
		<p align="center">
			<font face="Symbol">&#211;</font>&#160;<font color="#0000A0" size="2"><i>SciELO Brasil</i></font>
			<br/>
		...
		<select>
			...
			<xsl:if test="$selection_type != ''">
				<xsl:attribute name="multiple">
					<xsl:value-of select="$selection_type" />
				</xsl:attribute>
			</xsl:if>
		...
		**** File: file:///home/scielo/www/htdocs/stat_biblio/xsl/common.xsl
		...
		<a>
			<xsl:attribute name="href">
				...
				<xsl:value-of select="concat('&amp;server_action=',$popup_server_action)"/>
				<!-- 
				<xsl:value-of select="'&amp;debug=xml'"/>
				-->
			</xsl:attribute>
	...
	<xsl:template name="form">
		<xsl:param name="hidden_01_name"></xsl:param>
		<xsl:param name="hidden_01_value"></xsl:param>
		<xsl:param name="the_font_face"></xsl:param>
		<xsl:param name="the_font_size"></xsl:param>
		<xsl:param name="the_font_color"></xsl:param>
		<xsl:param name="the_bullet"></xsl:param>
		<xsl:param name="the_label"></xsl:param>
		...
		**** File: file:///home/scielo/www/htdocs/stat_biblio/xsl/common.xsl
		...
		<form>
			<xsl:attribute name="name">
				<xsl:value-of select="$the_form_name" />
			</xsl:attribute>
			<xsl:attribute name="action">
				<xsl:value-of select="$the_action" />
			</xsl:attribute>
			...
			<input>
				...
				<xsl:attribute name="name">
					<xsl:value-of select="$hidden_01_name" />
				</xsl:attribute>
				<xsl:attribute name="value">
					<xsl:value-of select="$hidden_01_value" />
				</xsl:attribute>
			</input>			
			<input>
				<xsl:attribute name="type">
			...
			<a>
				<xsl:attribute name="href">
					<xsl:value-of select="$the_href" />
				</xsl:attribute>
				<font>
					<xsl:attribute name="face">
						<xsl:value-of select="$the_font_face" />
					</xsl:attribute>
					<xsl:attribute name="size">
						<xsl:value-of select="$the_font_size" />
					</xsl:attribute>					
					<xsl:attribute name="color">
						<xsl:value-of select="$the_font_color" />
					</xsl:attribute>
