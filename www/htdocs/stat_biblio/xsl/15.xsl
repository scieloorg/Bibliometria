...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	**** File: 15.xsl
							...
							<xsl:choose>
								<xsl:when test="$sorted_column = '2'">
									<xsl:apply-templates select="journal_list/journal">
										<xsl:sort order="descending" select="totals/issues" data-type="number"/>
									</xsl:apply-templates>
								</xsl:when>
								<xsl:when test="$sorted_column = '3'">
									<xsl:apply-templates select="journal_list/journal">
										<xsl:sort order="descending" select="totals/articles" data-type="number"/>
									</xsl:apply-templates>
								</xsl:when>
								<xsl:when test="$sorted_column = '4'">
									<xsl:apply-templates select="journal_list/journal">
										<xsl:sort order="descending" select="totals/citing" data-type="number"/>
									</xsl:apply-templates>
								</xsl:when>
								<xsl:when test="$sorted_column = '5'">
									<xsl:apply-templates select="journal_list/journal">
										<xsl:sort order="descending" select="totals/cited" data-type="number"/>
									</xsl:apply-templates>
								</xsl:when>
								<xsl:when test="$sorted_column = '6'">
									<xsl:apply-templates select="journal_list/journal">
										<xsl:sort order="descending" select="totals/avarages/articles_issue" data-type="number"/>
									</xsl:apply-templates>
								</xsl:when>
								<xsl:when test="$sorted_column = '7'">
									<xsl:apply-templates select="journal_list/journal">
										<xsl:sort order="descending" select="totals/avarages/citing/issue" data-type="number"/>
									</xsl:apply-templates>
								</xsl:when>
								<xsl:when test="$sorted_column = '8'">
									<xsl:apply-templates select="journal_list/journal">
										<xsl:sort order="descending" select="totals/avarages/citing/article" data-type="number"/>
									</xsl:apply-templates>
								</xsl:when>
								<xsl:when test="$sorted_column = '9'">
									<xsl:apply-templates select="journal_list/journal">
										<xsl:sort order="descending" select="totals/avarages/cited/issue" data-type="number"/>
									</xsl:apply-templates>
								</xsl:when>
								<xsl:when test="$sorted_column = '10'">
									<xsl:apply-templates select="journal_list/journal">
										<xsl:sort order="descending" select="totals/avarages/cited/article" data-type="number"/>
									</xsl:apply-templates>
								</xsl:when>
								<xsl:otherwise>
									<xsl:apply-templates select="journal_list/journal">
										<xsl:sort order="ascending" select="label_list/label[@lang=$lang]" data-type="text"/>
									</xsl:apply-templates>
								</xsl:otherwise>
							</xsl:choose>
							<!--
	...
	<xsl:template match="journal[stat_list/stat]">
		...
		**** File: 15.xsl
		...
		<tr>
			...
			<td>
				<xsl:attribute name="title"><xsl:value-of select="$texts/text[find='N_DE_FASCICULOS']/replace"/></xsl:attribute>
			...
			<td>
				<xsl:attribute name="title"><xsl:value-of select="$texts/text[find='N_DE_ARTIGOS']/replace"/></xsl:attribute>
				<xsl:attribute name="width">6%</xsl:attribute>
				<xsl:attribute name="align">right</xsl:attribute>
				<b>
			...
			<td>
				<xsl:attribute name="title"><xsl:value-of select="$texts/text[find='N_DE_CITACOES_CONCEDIDAS']/replace"/></xsl:attribute>
				<xsl:attribute name="width">6%</xsl:attribute>
				<xsl:attribute name="align">right</xsl:attribute>
				<b>
			...
			<td>
				<xsl:attribute name="title"><xsl:value-of select="$texts/text[find='N_DE_CITACOES_RECEBIDAS']/replace"/></xsl:attribute>
				<xsl:attribute name="width">6%</xsl:attribute>
				<xsl:attribute name="align">right</xsl:attribute>
				<b>
			...
			<td>
				<xsl:attribute name="title"><xsl:value-of select="$texts/text[find='MEDIA_DE_ARTIGOS_POR_FASCICULO']/replace"/></xsl:attribute>
				<xsl:attribute name="width">6%</xsl:attribute>
				<xsl:attribute name="align">right</xsl:attribute>
				<b>
			...
			<td>
				<xsl:attribute name="title"><xsl:value-of select="$texts/text[find='MEDIA_DE_CITACOES_CONCEDIDAS_POR_FASCICULO']/replace"/></xsl:attribute>
				<xsl:attribute name="width">6%</xsl:attribute>
				<xsl:attribute name="align">right</xsl:attribute>
				<b>
			...
			<td>
				<xsl:attribute name="title"><xsl:value-of select="$texts/text[find='MEDIA_DE_CITACOES_CONCEDIDAS_POR_ARTIGO']/replace"/></xsl:attribute>
				<xsl:attribute name="width">6%</xsl:attribute>
				<xsl:attribute name="align">right</xsl:attribute>
				<b>
			...
			<td>
				<xsl:attribute name="title"><xsl:value-of select="$texts/text[find='MEDIA_DE_CITACOES_RECEBIDAS_POR_FASCICULO']/replace"/></xsl:attribute>
				<xsl:attribute name="width">6%</xsl:attribute>
				<xsl:attribute name="align">right</xsl:attribute>
				<b>
			...
			<td>
				<xsl:attribute name="title"><xsl:value-of select="$texts/text[find='MEDIA_DE_CITACOES_RECEBIDAS_POR_ARTIGO']/replace"/></xsl:attribute>
				<xsl:attribute name="width">6%</xsl:attribute>
				<xsl:attribute name="align">right</xsl:attribute>
				<b>
	...
	<xsl:template match="stat">
		...
		**** File: 15.xsl
		...
		<tr>
			...
			<xsl:attribute name="onMouseOut">this.style.backgroundColor='#F2F2F2';</xsl:attribute>
			<td>
				<xsl:attribute name="title"><xsl:value-of select="$texts/text[find='ANO']/replace"/></xsl:attribute>
				<xsl:attribute name="width">35%</xsl:attribute>
				<xsl:attribute name="nowrap">nowrap</xsl:attribute>
	...
	<xsl:template name="table_cell_choose">
		...
		<xsl:param name="the_column_number"/>
		<xsl:comment>
	...
	<xsl:template name="table_cell_form">
		<xsl:param name="the_text"/>
		<xsl:param name="the_sorted_column"/>
		<xsl:comment>
